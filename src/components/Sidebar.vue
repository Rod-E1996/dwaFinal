  ...
  <div class="flex">
    ...
    >
      ...
      >
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'AdminCatalog' ? activeClass : inactiveClass]"
          to="/catalog"
          >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Catálogo de productos</span>
        </router-link>
    
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'BuyingHistory' ? activeClass : inactiveClass]"
          to="/history"
        >
          <svg
            class="w-5 h-5"
          ...
          <span class="mx-4">Historial de compras</span>
        </router-link>
