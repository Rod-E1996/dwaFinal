<template>
    ...
    >
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3">
            <span class="font-semibold text-green-500">{{ title }}</span>
    ...
    >
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3">
            <span class="font-semibold text-blue-500">{{ title }}</span>
            <p class="text-sm text-gray-600">
                {{ message }}
            </p>
            </div>
    ...
    >
        ...
        <div class="px-4 py-2 -mx-3">
            <div class="mx-3">
            <span class="font-semibold text-yellow-500">{{ title }}</span>
            <p class="text-sm text-gray-600">
                {{ message }}
            </p>
            </div>
